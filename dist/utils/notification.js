...
exports.transactionMail = exports.resetPasswordMail = exports.transporter = void 0;
...
const resetPasswordMail = async (params) => {
    try {
...
const transactionMail = async (params) => {
    try {
        const info = await exports.transporter.sendMail({
            from: process.env.GMAIL_USER,
            to: params.to,
...
exports.transactionMail = transactionMail;
